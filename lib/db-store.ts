...
function toSettings(row: typeof siteSettings.$inferSelect): SiteSettings {
  return {
    ...
    heroImage1: row.heroImage1,
    heroImage2: row.heroImage2,
    aboutHeadline: {
    ...
    if (!existingSettings) {
      await db
        ...
        .values({
          ...
          heroImage1: seedSettings.heroImage1,
          heroImage2: seedSettings.heroImage2,
...
export async function saveSettingsToDb(settingsValue: SiteSettings) {
  ...
  await db
    ...
    .set({
      ...
      heroImage1: settingsValue.heroImage1,
      heroImage2: settingsValue.heroImage2,
